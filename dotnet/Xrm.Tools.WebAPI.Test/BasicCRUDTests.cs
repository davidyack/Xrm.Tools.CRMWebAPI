...
namespace Xrm.Tools.WebAPI.Test
{
    ...
    public class BasicCRUDTests : UnitTestBaseClass
    {
        ...
        [TestMethod]
        public async Task TestCreateRelatedRecords1()
        {
            var api = GetAPI();
        ...
        [TestMethod]
        public async Task TestCreateRelatedRecords2()
        {
            var api = GetAPI();
        ...
        [TestMethod]
        public async Task TestExpandQuery()
        {
            var api = GetAPI();
        ...
        [TestMethod]
        public async Task TestAltKeyUpdate()
        {
            var api = GetAPI();
        ...
        [TestMethod]
        public async Task TestAltKeyGet()
        {
            var api = GetAPI();
            string statid = "2bf3c48a-de2d-e511-80f8-c4346bac7da8";
        ...
        [TestMethod]
        public async Task TestFileFields()
        {
            var api = GetAPI();
