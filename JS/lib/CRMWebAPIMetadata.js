...
CRMWebAPI.prototype.CreateAutoNumberAttribute = function (entityID, displayName, schemaName, description, autoFormat ) {
    var self = this;
    return new Promise(function (resolve, reject) {

        var attrReq = {};
        attrReq.AutoNumberFormat = autoFormat;
        attrReq.AttributeType = "String";
        attrReq.AttributeTypeName = { Value: "StringType" };
        attrReq.Description = self._getLabelSet(description, 1033); 
        attrReq.DisplayName = self._getLabelSet(displayName, 1033); 
        attrReq.SchemaName = schemaName;
        attrReq.RequiredLevel = {};
        attrReq.RequiredLevel.Value = "None";
        attrReq.RequiredLevel.CanBeChanged = true;
        attrReq.RequiredLevel.ManagedPropertyLogicalName = "canmodifyrequirementlevelsettings";
        attrReq["@odata.type"] = "Microsoft.Dynamics.CRM.StringAttributeMetadata";
        attrReq.FormatName = { Value: "Text" };
        attrReq.MaxLength = 100;		
        
                self.Create('EntityDefinitions(' + entityID.toString() + ')/Attributes', attrReq).then(
                    function (createR) {
                        resolve(createR);
                    },
                    function (errorR) {
...
CRMWebAPI.prototype._getLabelSet = function (label, locid) {

    var ll = {};
    ll["@odata.type"] = "Microsoft.Dynamics.CRM.LocalizedLabel";
    ll.Label = label;
    ll.LanguageCode = locid;

    var l = {};
    l["@odata.type"] = "Microsoft.Dynamics.CRM.Label";
    l.LocalizedLabels = [];
    l.LocalizedLabels[0] = ll;
